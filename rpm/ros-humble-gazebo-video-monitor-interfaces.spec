...
Name:           ros-humble-gazebo-video-monitor-interfaces
Version:        0.8.1
Release:        1%{?dist}%{?release_suffix}
Summary:        ROS gazebo_video_monitor_interfaces package
...
%description
gazebo_video_monitor_interfaces defines interfaces for the
gazebo_video_monitor_plugins package.
